...
@Component({
  selector: 'app-reinraumloesung',
  imports: [TranslateModule, CommonModule, SlideshowComponent, KarriereSectionComponent],
  templateUrl: './reinraumloesung.component.html',
  styleUrl: './reinraumloesung.component.css'
})
export class ReinraumloesungComponent implements AfterViewInit, OnDestroy {
